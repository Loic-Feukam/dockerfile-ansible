...
Lien vers le repository de l'image Dockerhub -->  **https://hub.docker.com/r/loicmeng/ansible**
...
Lien vers le repository de l'image Dockerhub --> **https://hub.docker.com/r/loicmeng/ansible_client** 
